...
declare class Promise<R> {
   ...
   */
  constructor(callback: (resolve: (thenableOrResult?: R | Thenable<R>) => void, reject: (error: any) => void) => void): void;
   ...
   */
  then<U>(onFulfill: (value: R) => U|Thenable<U>, onReject?: (error: any) => U|Thenable<U>, onProgress?: (note: any) => any): Promise<U>;
  then<U>(onFulfill: (value: R) => U|Thenable<U>, onReject?: (error: any) => void|Thenable<void>, onProgress?: (note: any) => any): Promise<U>;
   ...
   */
  catch(onReject?: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;
  caught(onReject?: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;

  catch<U>(onReject?: (error: any) => U|Thenable<U>): Promise<U|R>;
  caught<U>(onReject?: (error: any) => U|Thenable<U>): Promise<U|R>;
   ...
   * Alias `.caught();` for compatibility with earlier ECMAScript version.
   */
  catch(predicate: (error: any) => boolean, onReject: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;
  caught(predicate: (error: any) => boolean, onReject: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;

  catch<U>(predicate: (error: any) => boolean, onReject: (error: any) => U|Thenable<U>): Promise<U|R>;
  caught<U>(predicate: (error: any) => boolean, onReject: (error: any) => U|Thenable<U>): Promise<U|R>;

  catch(ErrorClass: Function, onReject: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;
  caught(ErrorClass: Function, onReject: (error: any) => R|Thenable<R>|void|Thenable<void>): Promise<R>;

  catch<U>(ErrorClass: Function, onReject: (error: any) => U|Thenable<U>): Promise<U|R>;
  caught<U>(ErrorClass: Function, onReject: (error: any) => U|Thenable<U>): Promise<U|R>;
   ...
   */
  nodeify(callback: (err: any, value?: R) => void, options?: SpreadOption): Promise<R>;
  ...
  * });
   ...
   */
  // TODO type inference from array-resolving promise?
  map<Q, U>(mapper: (item: Q, index: number, arrayLength: number) => Thenable<U>, options?: ConcurrencyOption): Promise<U[]>;
  map<Q, U>(mapper: (item: Q, index: number, arrayLength: number) => U, options?: ConcurrencyOption): Promise<U[]>;
   ...
   */
  // TODO type inference from array-resolving promise?
  filter<U>(filterer: (item: U, index: number, arrayLength: number) => Thenable<boolean>, options?: ConcurrencyOption): Promise<U[]>;
  filter<U>(filterer: (item: U, index: number, arrayLength: number) => boolean, options?: ConcurrencyOption): Promise<U[]>;
   ...
   */
  each<R, U>(iterator: (item: R, index: number, arrayLength: number) => U | Thenable<U>): Promise<R[]>;
  ...
  // FLOW: had to reverse the order of these to get Promise.delay(number).then() to work
  ...
  static promisifyAll(target: Object, options?: PromisifyAllOptions): any;
  ...
  static all<T1, T2>(values: [Thenable<T1>, Thenable<T2>]): Promise<[T1, T2]>;
  static all<T1, T2, T3>(values: [Thenable<T1>, Thenable<T2>, Thenable<T3>]): Promise<[T1, T2, T3]>;
  static all<T1, T2, T3, T4>(values: [Thenable<T1>, Thenable<T2>, Thenable<T3>, Thenable<T4>]): Promise<[T1, T2, T3, T4]>;
  static all<T1, T2, T3, T4, T5>(values: [Thenable<T1>, Thenable<T2>, Thenable<T3>, Thenable<T4>, Thenable<T5>]): Promise<[T1, T2, T3, T4, T5]>;
  // array with values
   ...
   */
  // promise of array with promises of value
  static map<R, U>(values: Thenable<Thenable<R>[]>, mapper: (item: R, index: number, arrayLength: number) => Thenable<U>, options?: ConcurrencyOption): Promise<U[]>;
  static map<R, U>(values: Thenable<Thenable<R>[]>, mapper: (item: R, index: number, arrayLength: number) => U, options?: ConcurrencyOption): Promise<U[]>;

  // promise of array with values
  static map<R, U>(values: Thenable<R[]>, mapper: (item: R, index: number, arrayLength: number) => Thenable<U>, options?: ConcurrencyOption): Promise<U[]>;
  static map<R, U>(values: Thenable<R[]>, mapper: (item: R, index: number, arrayLength: number) => U, options?: ConcurrencyOption): Promise<U[]>;
  ...
  // array with values
  static map<R, U>(values: R[], mapper: (item: R, index: number, arrayLength: number) => Thenable<U>, options?: ConcurrencyOption): Promise<U[]>;
  static map<R, U>(values: R[], mapper: (item: R, index: number, arrayLength: number) => U, options?: ConcurrencyOption): Promise<U[]>;
   ...
   */
  // promise of array with promises of value
  static filter<R>(values: Thenable<Thenable<R>[]>, filterer: (item: R, index: number, arrayLength: number) => Thenable<boolean>, option?: ConcurrencyOption): Promise<R[]>;
  static filter<R>(values: Thenable<Thenable<R>[]>, filterer: (item: R, index: number, arrayLength: number) => boolean, option?: ConcurrencyOption): Promise<R[]>;

  // promise of array with values
  static filter<R>(values: Thenable<R[]>, filterer: (item: R, index: number, arrayLength: number) => Thenable<boolean>, option?: ConcurrencyOption): Promise<R[]>;
  static filter<R>(values: Thenable<R[]>, filterer: (item: R, index: number, arrayLength: number) => boolean, option?: ConcurrencyOption): Promise<R[]>;
  ...
  // array with values
  static filter<R>(values: R[], filterer: (item: R, index: number, arrayLength: number) => Thenable<boolean>, option?: ConcurrencyOption): Promise<R[]>;
  static filter<R>(values: R[], filterer: (item: R, index: number, arrayLength: number) => boolean, option?: ConcurrencyOption): Promise<R[]>;
   ...
   */
  // promise of array with promises of value
  static each<R, U>(values: Thenable<Thenable<R>[]>, iterator: (item: R, index: number, arrayLength: number) => U | Thenable<U>): Promise<R[]>;
  // array with promises of value
  static each<R, U>(values: Thenable<R>[], iterator: (item: R, index: number, arrayLength: number) => U | Thenable<U>): Promise<R[]>;
